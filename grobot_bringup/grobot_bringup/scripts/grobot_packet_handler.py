...
class PacketHandler:
   def __init__(self, _port_name, _baud_rate):
      ...
      # self._battery = [0.0, 0.0, 0.0] # 미니버전에는 있음
      ...
      if self.get_port_state() == True:
         ...
         if whole_packet:
            ...
            try:
               ...
               #    self._battery = [float(packet[1]), float(packet[2]), float(packet[3])]  ## 미니에는 있음
            except:
               pass
